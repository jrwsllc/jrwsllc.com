<?php
/**
 * Shared footer + page-close markup for JRWS LLC site.
 */
?>
    ...
    <div class="footer-inner">
      <div class="footer-top">
        <div class="footer-col footer-col-brand">
          ...
          <p class="footer-copy">&copy; <?php echo date("Y"); ?> JRWS LLC.<br>All rights reserved.</p>
        </div>

        <div class="footer-col">
          <h3 class="footer-col-heading">Stay Connected</h3>
          <ul class="footer-social" aria-label="Social links">
            <!-- PLACEHOLDER: replace with real Instagram link -->
            <li>
              <a href="#" aria-label="JRWS LLC on Instagram">
            ...
            <!-- PLACEHOLDER: replace with real YouTube link -->
            <li>
              <a href="#" aria-label="JRWS LLC on YouTube">
